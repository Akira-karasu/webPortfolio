export const projects = {
  2023: [
    {
      ...
      description:
        'CipherHub is a frontend practice project built with HTML, CSS, and JavaScript, focused on exploring basic cryptography concepts such as the Caesar Cipher. It was created to strengthen my frontend development skills while learning the fundamentals of encryption and decryption.',
      links: [
        {
          platform: 'github',
  ...
  2025: [
    {
      ...
      description:
        'A full-stack activity project focused on practicing frontend and backend development using modern frameworks. Developed a To-Do List application with React and NestJS while applying RESTful API, MVC architecture, TypeORM, and MySQL.',
      links: [
        {
          platform: 'github',
          logo: '../../../images/logo/techs/github.png',
    ...
    },
    {
      ...
      techStack: ['React', 'NestJS', 'TypeScript', 'TypeORM', 'Restful API', 'MVC', 'MySQL'],
      description:
        'A full-stack activity project focused on practicing frontend and backend development through a library management application. Applied React and NestJS with RESTful API, MVC architecture, TypeORM, and MySQL to implement the application and manage its data.',
      links: [
        {
          platform: 'github',
          logo: '../../../images/logo/techs/github.png',
    ...
    },
    {
      ...
      description:
        'This project is a group project for Team-portfolio, this is also a project for practicing and learning React Js.',
      techStack: ['React'],
      links: [
        {
          platform: 'github',
    ...
    },
    {
      ...
      role: 'Web Designer & Front-end Developer',
      description:
        'This is a collaborative project and Its about making an interactive web about rizals life and work and It is also a practice for front-end skills using React.js',
      techStack: ['React'],
      links: [
        {
          platform: 'weblink',
  ...
  2026: [
    ...
    },
    {
      ...
      description:
        'Developed a mobile application for online appointments, QR-based e-ticket verification, and queue management. Built using React Native (Expo) with an MVC architecture and Prototype Agile methodology, integrating a NestJS backend with TypeORM and MySQL.',
      links: [
        {
          platform: 'github',
          logo: '../../../images/logo/techs/github.png',
